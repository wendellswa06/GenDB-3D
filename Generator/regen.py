...
def main():
    ...
    prompt_file_name = "/workspace/failed.txt"
    with open(prompt_file_name, "r") as file:
        ...
        for line in file:
            ...
            os.makedirs(os.path.dirname(f"{DB_PATH}/{folder_id}/"), exist_ok=True)
            ...
            output_path2 = f"{DB_PATH}/{folder_id}/mesh.glb"
